      ...
      <main className="flex min-w-0 flex-1 flex-col overflow-hidden">
        ...
        <div className="flex-1 overflow-y-auto px-6 py-8 md:px-8">
          <div className="max-w-2xl mx-auto flex flex-col gap-10">
            ...
            {/* Sign out */}
            <section className="rounded-2xl border border-slate-200 dark:border-surface-highlight bg-white dark:bg-surface-dark p-6">
              <h2 className="text-lg font-semibold text-slate-900 dark:text-white mb-4">Sign out</h2>
              ...
              <button
                ...
                className="rounded-xl border border-slate-300 dark:border-slate-600 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-slate-300 hover:bg-slate-100 dark:hover:bg-slate-700/50 transition-colors"
              >
                Log out
              </button>
            </section>
